<template>
  <v-row no-gutters class="flex-column">
    <div>
      <AppBanner :bannerImage="bannerImage" title="SPORT" />
    </div>
...
export default {
  ...
  data() {
    return {
      bannerImage: require('@/assets/images/sports-banner.png'),
      fetchedHeadlines: [],
      dialog: false,
      clickedPost: null,
      waitingData: false,
  ...
  methods: {
    async fetchGlobalHeadlines() {
      ...
      let response = await this.$store.dispatch('TopHeadlines', 'sports')
